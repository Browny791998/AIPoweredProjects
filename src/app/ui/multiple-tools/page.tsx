...
import { Chatmessage } from "../../api/multiple-tools/route";
                                                    ...
                                                    <div key={`${message.id}-${index}`} className="my-2 rounded-2xl overflow-hidden border border-slate-100 dark:border-zinc-700 bg-white dark:bg-zinc-800 shadow-xl max-w-sm animate-in fade-in zoom-in-95 duration-300">
                                                        {part.state === "input-streaming" || part.state === "input-available" ? (
                                                            <div className="flex items-center gap-4 p-5">
                                                                ...
                                                                <div className="flex flex-col">
                                                                    <span className="text-sm font-bold uppercase tracking-wider opacity-70">Getting location...</span>
                                                                    <span className="text-xs text-slate-500 dark:text-zinc-400">Searching for {part.input?.name}...</span>
                                                                </div>
                                                            </div>
                                                        ) : part.state === "output-streaming" || part.state === "output-available" ? (
                                                            <div className="p-5 flex items-center gap-4 text-green-600 dark:text-green-400 bg-green-50/50 dark:bg-green-950/10">
                                                                <div className="shrink-0 h-10 w-10 rounded-xl bg-green-100 dark:bg-green-900/20 flex items-center justify-center">
                                                                ...
                                                                <div className="flex flex-col">
                                                                    <span className="text-sm font-bold uppercase tracking-wider opacity-70">Location Found</span>
                                                                    <span className="text-sm font-semibold">{part.output}</span>
                                                                </div>
                                                            </div>
                                                        ) : part.state === "output-error" ? (
                                                            <div className="p-5 flex items-center gap-4 text-red-600 dark:text-red-400 bg-red-50/50 dark:bg-red-950/10">
